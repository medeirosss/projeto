...
def get_host_info(active_jobs: int = 0) -> dict[str, Any]:
    ...
    return {
        ...
        "capabilities": {"nmap_discovery": nmap_capability(), "service_discovery": nmap_capability(), "credential_validate": {"available": True, "max_attempts_per_host": 2}, "deep_inventory": {"available": True}},
    }
