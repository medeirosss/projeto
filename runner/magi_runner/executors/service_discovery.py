...
class ServiceDiscoveryExecutor:
    ...
    def run(self,job:dict[str,Any],workdir:str,timeout_seconds:int)->ExecutionResult:
        ...
        args=[nmap,'-Pn','-n','-sV','--version-light','--top-ports','100','--open','-T4','--max-retries','1','-oX','-',target]
        try:
